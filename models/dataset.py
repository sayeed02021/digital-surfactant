...
class Dataset(tud.Dataset):
    ...
    Source_Mol_pCMC,Target_Mol_pCMC,Delta_pCMC,
    Source_Mol_Area_min,Target_Mol_Area_min,Delta_Area_min,
    Source_Mol_AW_ST_CMC,Target_Mol_AW_ST_CMC,Delta_AW_ST_CMC,
    Transformation,Core"""

    def __init__(self, data, vocabulary, tokenizer, prediction_mode=False, PROPERTIES=None):
        """
